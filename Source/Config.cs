 ...
 static class Config
{
    ...
    public static int GripTextOnScreenColor = Color.gray;
    public static string GripTextOnScreenFont = "romand";
    public static int GripLineColor = Color.gray;
    ...
    //TINCHO 2023.05.22 > Config.class implementation
    public static string dirResources = Application.path;
    ...
    public static int OnScreenHelpColor = Color.LightGray;
    public static int ColorForSelected = &H70E000;
    public static int ColorForRemark = &H0000FF00;
    ...
    public static string OdaPath = User.Home;
